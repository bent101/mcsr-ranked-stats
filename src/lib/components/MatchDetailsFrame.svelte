...
<div class="pointer-events-none fixed inset-x-0 bottom-0 z-10 px-4">
  <div
    class={cn(
      "frame duration-250 pointer-events-auto relative ml-auto max-w-xl overflow-hidden rounded-t-3xl border border-zinc-700/60 bg-zinc-800 shadow-lg shadow-black/30 transition-transform 2xl:ml-[52rem] 2xl:max-w-2xl 3xl:max-w-3xl",
