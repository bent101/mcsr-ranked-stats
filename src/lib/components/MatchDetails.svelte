<script lang="ts">
	...
	export let match: ReturnType<typeof formatDetailedMatch> | undefined = undefined;
...
{:else}
	<!-- <div class="py-6 text-center text-zinc-500">Click a match to see its details</div> -->
{/if}
