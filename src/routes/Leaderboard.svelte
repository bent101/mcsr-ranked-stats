...
<div class="min-h-screen w-80 bg-zinc-950">
	<h1
		bind:this={titleContainer}
		class="border-r-2 border-zinc-700 bg-zinc-950/70 p-4 text-center text-sm font-extrabold uppercase tracking-wide text-zinc-500">
		MSCR Ranked Leaderboard
	</h1>
	<div
		class="sticky top-0 z-20 mx-auto mb-2 border-r-2 border-zinc-700 bg-zinc-950/70 p-2 text-zinc-500 backdrop-blur-md">
		<input
