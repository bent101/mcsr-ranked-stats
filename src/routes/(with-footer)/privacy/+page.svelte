...
<div class="px-4 pt-16 pb-32">
  <div class="mx-auto max-w-3xl">
    ...
    <p>
      ...
      https://mcsrranked.com, as well the MCSR Ranked applications (hereinafter
      referred to as &quot;Service&quot;).{" "}
      <br />
      <br />
      Our Privacy Policy governs your visit to https://mcsrranked.com, as well as
      your usage of the MCSR Ranked applications, and explains how we collect, safeguard
      and disclose information that results from your use of our Service. We use
      your data to provide and improve Service. <br /> <br />
      By using Service, you agree to the collection and use of information in accordance
      with this policy. Unless otherwise defined in this Privacy Policy, the terms
    ...
    <ul>
      <li>
        Minecraft Account: Key Pair containing UUID data generated through
      ...
      <li>
        ...
        <ul>
          <li>
            Identifying Patreon Account ID for check subscribing special tiers
          </li>
        </ul>
      </li>
      <li>
        ...
        <ul>
          <li>
            Identifying Discord User ID and display Discord tag on the MCSR
            Ranked profile
          </li>
        </ul>
      </li>
      <li>
        ...
        <ul>
          <li>
            Identifying Twitch Channel ID and display Twitch channel link on the
            MCSR Ranked profile
          </li>
        </ul>
      </li>
      <li>
        ...
        <ul>
          <li>
            Identifying YouTube Channel ID and display YouTube channel link on
            the MCSR Ranked profile
          </li>
        </ul>
      </li>
    </ul>

    <h2>6. Tracking & Cookies Data</h2>
    <p>
    ...
    <h2>7. Use of Data</h2>
    <p>MCSR Ranked uses the collected data for various purposes:</p>
    <ul>
    ...
    <p>
      ...
      Republic of Korea and choose to provide information to us, please note
      that we transfer the data, including Personal Data, to Republic of Korea
      and process it there. Your consent to this Privacy Policy followed by your
      submission of such information represents your agreement to that transfer.
      MCSR Ranked will take all the steps reasonably necessary to ensure that
    ...
    <ul>
      <li>
        ...
        <p>
          Google Analytics is an analytics service offered by Google that tracks
          and reports traffic/usage. Google uses the data collected to track and
    ...
    <ol>
      <li>
        By email:{" "}
        <a href="mailto:mcsrranked@gmail.com"> mcsrranked@gmail.com </a>
      </li>
      <li>
        By joining our Discord server:{" "}
        <a href="https://mcsrranked.com/discord">
    ...
    <ul>
      <li>
        Feb 22, 2024: Described details on how to use third parties data used in
        Other Data (5).
      </li>
    </ul>
  </div>
